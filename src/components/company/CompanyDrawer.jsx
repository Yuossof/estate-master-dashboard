      ...
      {isOpen && (
        ...
        >
          ...
          >
            <CardSpotlight
              isDark={isDark}
              className={"bg-transparent w-full !mx-0 !px-0 h-full"}
            >
              <div className="relative w-full h-full">
                {/* Close Btn */}
                <button
                  onClick={onClose}
                  className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-colors absolute dark:-top-5 top-3 right-4"
                >
