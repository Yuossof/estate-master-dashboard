...
const EditServiceCategoryForm = ({ serviceCategories, setServiceCategories, handleSubmit, errors, setErrors, isLoading }) => {
                ...
                <div className='grid md:grid-cols-2 grid-cols-1 gap-4'>
                    ...
                    <div className="flex flex-col min-w-[150px]">
                        ...
                        <Input
                            ...
                            name="name_ar"
                            id="name_ar"
                            value={serviceCategories.name_ar}
                            onChange={handleChange}
                        />
