...
const CreateThingsTodoCategoriesForm = ({ thingsTodoCategoryData, setThingsTodoCategoryData, handleSubmit, errors, setErrors, isLoading }) => {
...
export default CreateThingsTodoCategoriesForm