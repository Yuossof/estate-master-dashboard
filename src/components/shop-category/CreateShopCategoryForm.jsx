...
const CreateShopCategoryForm = ({ shopCategoryData, setShopCategoryData, handleSubmit, errors, setErrors, isLoading }) => {

    const handleChange = (e) => {
        const { name, value } = e.target
        setErrors(prev => ({ ...prev, [name]: "" }))
        setShopCategoryData(prev => ({
            ...prev,
            [name]: value
        }))
    }
                ...
                <div className='grid md:grid-cols-2 grid-cols-1 gap-4'>
                    ...
                    <div className="flex flex-col min-w-[150px]">
                        ...
                        <Input
                            ...
                            name="name_ar"
                            id="name_ar"
                            value={shopCategoryData.name_ar}
                            onChange={handleChange}
                        />
...
export default CreateShopCategoryForm