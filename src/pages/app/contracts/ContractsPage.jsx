  ...
  useEffect(() => {
    ...
    const getContracts = async () => {
      try {
        ...
        setIsLoading(true);
        const data = await getContractsService(9, page, debouncedSearchKey, selectedCompany.id, abort.signal);
        setContractsRows(data.data.items || []);
        ...
        {isLoading ? (
          ...
          selectedCompany.id ? (
            <ContractsTable
              ...
              setContractsRows={setContractsRows}
              refetch={refetch}
