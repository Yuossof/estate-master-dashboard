...
const CreateCompanyUserPage = () => {
    ...
    return (
        <div className="space-y-6">
            <Card>
                <div className="mb-6">
                    <h1 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Create Company User</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new company user</p>
                </div>
