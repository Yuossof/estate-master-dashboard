...
const columns = [
    ...
    { label: "Is Current" },
    { label: "Notification (2 days)" },
    { label: "Notification (10 days)" },
    { label: "Action" },
];
    ...
    useEffect(() => {
        ...
        const getContracts = async () => {
            try {
                ...
                setIsLoading(true);
                const data = await getInvoicesService(12, page, debouncedSearchKey, selectedCompany.id, abort.signal);
                console.log(data)
                setInvoicesRows(data.data.items || []);
            ...
            <Card noborder>
                ...
                <div className="mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <p className="md:text-base text-[14px] text-gray-500 dark:text-gray-400 mt-1">
                        Browse, search, and manage registered invoices
                    </p>
                </div>
                ...
                {isLoading ? (
                    ...
                    selectedCompany.id ? (
                        <InvoicesTable
                            columns={columns}
                            invoicesRows={invoicesRows}
                            setInvoicesRows={setInvoicesRows}
                            refetch={refetch}
                            setRefetch={setRefetch}
                        />
                    ) : (
                        <div className="w-full flex justify-center my-5">
                            <p className="text-gray-600 dark:text-gray-400">Select a company first!</p>
                        </div>
                    )
