        ...
        <div>
                  ...
                  {index > 0 && (
                    <div className="flex-none relative">
                      <button
                        ...
                        type="button"
                        className="inline-flex items-center justify-center h-10 w-10 bg-red-600 text-lg border rounded border-red-600 text-white"
                      >
          ...
          <div className="mt-4">
            <Button
              ...
              className="text-gray-600 p-0 dark:text-gray-300"
              onClick={() => append()}
            />
          </div>
        </div>
